...
export default function AvailableAssignmentsPage() {
    ...
    async function fetchData() {
        ...
        if (profileRes.success && profileRes.data) {
            const res = await getStudentAvailableAssessments(profileRes.data.id, 'ASSIGNMENT');
    ...
    return (
        <div className="p-8">
            <StudentAssessmentList
                ...
                description="New tasks waiting for your input. Stay on top of your deadlines!"
                assessments={data}
                isLoading={isLoading}
                type="ASSIGNMENT"
                emptyMessage="No new assignments assigned yet."
            />
        </div>
    );
}
