...
export default function CreateTestPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const res = await createAssessment({
            ...formData,
            type: AssessmentType.TEST, // Explicitly creating a TEST
            teacherId,
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground font-medium">
                        Set up a new quiz or continuous assessment test.
                    </p>
                </div>
            </div>
                ...
                <CardContent className="p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-gray-500">Test Title</label>
                            <Input
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-black uppercase tracking-widest text-gray-500">Total Marks</label>
                                <Input
                                    type="number"
                                    className="h-12 bg-white/50 border-brand-100"
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-gray-500">Additional Instructions</label>
                            <Textarea
                                placeholder="Instructions for students regarding the test format..."
